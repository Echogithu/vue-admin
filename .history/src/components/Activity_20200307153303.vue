...
export default {
  ...
  joinTest(item){
    ...
    StudentAddTestRecord(studentData.testRecordID,studentData).then(res=>{
      // console.log(res.data)
      // alert('加入成功')
      // this.$router.push(`/test/content/${studentData.testRecordID}`)
      
      // this.$router.push({name: 'TestContent', params: { id: studentData.testRecordID }})  
      
      let newpage = this.$router.resolve({ 
        name: 'TestContent',
        path: `/test/content/${studentData.testRecordID}`,
        // params: { id: studentData.testRecordID } 
      }) 
      console.log(newpage)
      window.open(newpage.href, '_blank');
      // this.$router.push({
      //   // path:`/test/content/${studentData.testRecordID}`,
      //   path: '/../views/Activities/TestContent.vue',
      //   query: {
      //     id: studentData.testRecordID
      //   }
      // })
    })
  }
