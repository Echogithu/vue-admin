  ...
  <div class="testEditWrap">
    ...
    <el-container>
      <el-aside width="50%" class="left">
        ...
        <template v-for="(test,index) in testArrays" :key="index">
          <el-card class="box-card topicCard" :class="focus == index? 'focus':''" @click.native="choiced(index)"> 
          ...
          <div class="questionChoice" v-for="(item, index) in testArrays[index].answerOptions">
            <div class="item">
          ...
          <div class="questionAnswer">
            <div class="answer">正确答案:
              <span v-for="item in testArrays[index].correctAnswers">{{item}}</span>
            </div>
      ...
      <el-main  class="right">
          <div class="multipleChoice">
            ...
            <div class="answersGroup">
              ...
              <template v-for="(item, index) in testArrays[focus].answerOptions" >
