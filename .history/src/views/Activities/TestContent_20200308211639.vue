      ...
      <div class="main"> 
          ...
          <div class="questionChoice" v-for="(item, index) in testArrays[focus].answerOptions" :key="index">
            <div class="item">
              ...
              <el-radio-group v-model="studentAnswer.chooseAnswers[focus]" size="small">
                 <el-radio-button     :label="item.option || 0"></el-radio-button>
              </el-radio-group>
        ...
        <div class="mainContent"  >
          <template v-for="(item, index) in testArrays">
            <span :key="index" class="topics" :class="studentAnswer.chooseAnswers[focus] !== null ? 'selected':''" >{{index+1}}</span>
          </template>
        </div>
...
export default {
  ...
  methods: {
    ...
    submitStudentAnswer(){
      ...
      console.log(this.studentAnswer.chooseAnswers[1])
