      ...
      <div class="main"> 
        <div class="mainContent" v-if=" index < testArrays.length">
          ...
          <div class="questionChoice" v-for="(item, index) in testArrays[index].answerOptions" :key="index">
            <div class="item">
              <!-- 单选 -->
              <!-- <el-radio-group v-model="studentAnswer.chooseAnswers[0]" size="small"> -->
                 <el-radio-button   v-model="studentAnswer.chooseAnswers[index]"  :label="item.option"></el-radio-button>
              <!-- </el-radio-group> -->
              <div>{{studentAnswer.chooseAnswers[index]}}</div>
