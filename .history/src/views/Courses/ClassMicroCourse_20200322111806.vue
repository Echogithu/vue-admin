...
import {AddTest, GetTests,AddMicroCourse } from '@/api/activities'
...
export default {
  ...
  methods: {
    ...
    */
    ...
    {
      this.microCourseForm.classId = this.classId;
      console.log(this.microCourseForm)
      AddMicroCourse(this.microCourseForm).then(res=>{
        this.$message.success('保存成功')
