      ...
      <el-col :span="15">
        <div class="grid-content ">
          <el-card class="activityLists">
            <el-button type="text" :class="showAll? 'active' : ''">全部活动</el-button>
            <el-button type="text" :class="showMicrocourse? 'active' : ''" @click="choose(type='microcourses')">微课</el-button>
            <el-button type="text"  :class="showTest? 'active' : ''" @click="choose(type='showtest')">测验</el-button>
  ...
  methods: {
    ...
    */
    ...
    choose(type){
      ...
      switch(type){
        case "microcourse":
          this.activityType = "microcourse"
          break;
        case "showtest":
          this.activityType = "showtest"
          break;
      }
