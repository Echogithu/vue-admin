    ...
    <el-row :gutter="20">
      ...
      <el-col :span="15">
        <div class="grid-content ">
            ...
            <el-button type="success" class="addActivity"  v-if="role">
              <el-dropdown >
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item icon="el-icon-reading">新建微课</el-dropdown-item>
          ...
          <!-- 新建微课 -->
          <el-dialog  :visible.sync="microCourseForm = true" class="testForm">
            <el-form  :model="microCourseData" :label-width="testFormLabelWidth"  >
              <el-form-item label="测验名称" :label-width="testFormLabelWidth">
                <el-input v-model="microCourseData.title" autocomplete="off" placeholder="测验名称"></el-input>
              </el-form-item>
...
import {AddTest, GetTests } from '@/api/activities'
